...
- [ ] 0.1.3 Create CLI binary crate skeleton (code-viz-cli)
  - Files:
...
- [ ] 0.1.4 Create test structure skeleton
  - Files:
...
- [ ] 1.2.2 Add parser unit and snapshot tests
...
- [ ] 1.4.2 Add integration tests for full analysis pipeline
...
- [ ] 2.1.2 Implement output formatters (output/json.rs, csv.rs, text.rs)
...
- [ ] 2.2.2 Implement config init command (commands/config.rs)
...
- [ ] 3.1.2 Add watch mode E2E tests (cli_e2e_test.rs)
  - Files: `crates/code-viz-cli/tests/cli_e2e_test.rs`
...
- [ ] 4.1.2 Implement baseline comparison for CI (analyze command enhancement)
...
- [ ] 4.2.2 Create GitHub Actions CI workflow
